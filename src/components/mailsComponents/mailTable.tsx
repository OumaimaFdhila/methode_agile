...
export default function MailTable(){
    ...
    }, [filterValue, hasSearchFilter, mails, roleFilter, viewedFilter]);
    ...
    }, [filterValue, filteredItems, onClear, onRowsPerPageChange, onSearchChange, roleFilter, viewedFilter, rowsPerPage]);
                    ...
                    items.map((mail)=>(
                        <TableRow key={mail.id} onClick={()=>{
                          ...
                          onOpen()
                            ...
                            <TableCell>{mail.viewed ? "seen" : "unseen"}</TableCell>
