...
export default function uber(){
    return(
        <div className="relative top-[-4rem] w-full overflow-x-hidden flex flex-col items-center">
            ...
            <div className="w-full flex flex-col  lg:flex-row lg:justify-evenly bg-[#eeee]/30  mb-20 py-10">   
                ...
                <div className="lg:mt-40 flex flex-col justify-start items-center mb-4 ">
                    <div className="w-[150px] shadow-xl mx-5 aspect-square bg-white rounded-full flex justify-center items-center">
                ...
                <div className="lg:mt-40 flex flex-col justify-start items-center ">
                    <div className="w-[150px] shadow-xl mx-5 aspect-square bg-white rounded-full flex justify-center items-center ">
